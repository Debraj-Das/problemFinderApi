...
matrix_path = os.path.join(BASE_DIR, 'dmoj/preprocess/matrix.pkl')
vectorizer_path = os.path.join(BASE_DIR, 'dmoj/preprocess/vectorizer.pkl')
data = os.path.join(BASE_DIR, 'dmoj/preprocess/problem.csv')
